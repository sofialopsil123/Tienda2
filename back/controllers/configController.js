...
const obtener_config_admin = async function(req,res){
     if(req.user){
         if(req.user.role =='admin'){
             ...
             let reg = await Config.findById({_id:"64c7e0fc482339f50e2845a8"});
...
const actualiza_config_admin = async function(req,res){
    if(req.res){
        if(req.user.role =='admin'){
            ...
            let data = req.body;
            //si hay una imagen se ejecuta todo el codigo
            if(req.files){
                ...
                let reg = await Config.findByIdAndUpdate({_id:"64c7e0fc482339f50e2845a8"},{
...
//esta funcion permite crear nuestras categorias dinamicas que se reflejen en en index del modulo producto
